export function ProPlayerHistoryManager( strHistoryListWrapperID )
{
		...
		this.objCurrentHistoryItem = { 	url: "",
										title: "",
										name: "",
										channel: ""};
        ...
        this.addHistoryItem = function(strPackageID, strSegmentID, strPackageTitle,
        					 strPackageChannel, strSegmentTitle, strType)
        {
			...
			var newHistoryItem = { packageTitle: strPackageTitle,
