...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"--js-ProPlayerEngine.js":[function(require,module,exports) {
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ProPlayerEngine = function ProPlayerEngine() {
  _classCallCheck(this, ProPlayerEngine);
  ...
  *****************************************/
  ...
  this.initializeProPlayerEngine = function (mediaType, mediaCode, mediaStartTime, posterImage, sourcesArray, chaptersArray) {
    ...
    this.initializePanZoom(); //this.initializePlaybackSpeeds();
  ...
  this.setChaptersArray = function (theChaptersArray) {
    if (typeof theChaptersArray !== "undefined") {
      ...
      for (var i = 0; i < this.a_Chapters.length; i++) {
  ...
  *****************************************/
  ...
  this.sortSourcesArray = function () {
    ...
    for (var i = 0; i < this.a_VideoSources.length; ++i) {
      if (thePlayer.isIOS()) {
    ...
    for (var _i = 1; _i < this.a_VideoSources.length; ++_i) {
      var src1 = this.a_VideoSources[_i];
      var src2 = this.a_VideoSources[_i - 1];
  ...
  this.selectInitialSource = function () {
    ...
    if (this.str_SavedResolution != "") {
      ...
      if (srcURL == "") {
        for (var _i2 = 0; _i2 < this.a_VideoSources.length; ++_i2) {
          //trim off p60
          strBaseResolution = this.str_SavedResolution.toString().substring(0, 3);
          strSourceResolution = this.a_VideoSources[_i2]["resolution"];

          if (strSourceResolution.search(strBaseResolution) > -1) {
            srcURL = this.a_VideoSources[_i2]["url"];
            selectedSourceIndex = _i2;
            break;
          }
        }
  ...
  *****************************************/
  ...
  this.playerEndCallback = function () {
    ...
    if (savedPlaybackPositions !== null) {
      ...
      for (var i = 0; i < savedPlaybackPositions.length; i++) {
  ...
  *****************************************/
  ...
  this.setPlayerZoom = function (zoomFactor) {
    if (zoomFactor < 1.05) {
      ...
      var theArray = this.obj_PanZoom.panzoom("getTransform"); //console.log("Current Transform After Zoom Is: " + theArray);
    }
  };
  ...
  */
  ...
  this.onUserChangedVideoResolution = function () {
    ...
    var selectedSource = radioButtons.index(radioButtons.filter(':checked'));
    var sourceObject = this.a_VideoSources[selectedSource];
    var currentTime = this.f_CurrentTime;
    var currentSpeed = this.f_PlaybackRate;
    this.str_SavedResolution = sourceObject["resolution"];
    var bWasZoomed = this.b_ZoomEnabled;
  ...
  */
  ...
  this.updateSelectedSpeed = function () {
    ...
    for (var i = 0; i < this.a_PlaybackSpeeds.length; i++) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","--js-ProPlayerEngine.js"], null)
//# sourceMappingURL=/--js-ProPlayerEngine.d6529f27.js.map