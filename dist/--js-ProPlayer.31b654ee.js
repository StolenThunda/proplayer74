...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"node_modules/mobile-detect/mobile-detect.js":[function(require,module,exports) {
var define;
...
define(function () {
     ...
     * @private
     */
    impl.findMatch(rules, userAgent) {
     ...
     * @private
     */
    impl.findMatches(rules, userAgent) {
        var result = [];
        for (var key in rules) {
            if (hasOwnProp.call(rules, key)) {
                if (rules[key].test(userAgent)) {
...
},{}],"--js-ProPlayer.js":[function(require,module,exports) {
...
function () {
  function ProPlayer() {
    ...
    _classCallCheck(this, ProPlayer);

    this.gc_BranchPath = '/' + '{branch_path}';

    var MobileDetect = require('mobile-detect');

    this.theMobileDetect = new MobileDetect(window.navigator.userAgent); // Top Level Objects
    ...
    window.addEventListener('onpopstate', function (event) {
      ...
      var theState = event.state; //console.log("Popping state: " + JSON.stringify(theState));
  ...
  _createClass(ProPlayer, [{
    key: "initializeWithoutPackage",
    value: function initializeWithoutPackage(bUpdateURL) {
    ...
    key: "resetLoadingFlags",
    value: function resetLoadingFlags() {
      this.bPackageDataLoadingFinished = false;
      this.bSegmentDataLoadingFinished = false;
      this.bPackageDataLoadingStarted = false;
      this.bSegmentDataLoadingStarted = false;
    ...
    key: "resetPackageTitle",
    value: function resetPackageTitle() {
      this.pushPackageTitle("TXBA Pro Player");
      $("#proPlayerWrapper").toggleClass("has-info", false);
    }
  }, {
    key: "resetPlayerTitle",
    value: function resetPlayerTitle() {
    ...
    key: "resetPackageSections",
    value: function resetPackageSections() {
    ...
    key: "resetSegmentChapters",
    value: function resetSegmentChapters() {
      $('#chapterList').empty();
      $('#chapterListEmpty').text("No segment loaded.");
      $('#chapterListEmpty').toggle(true);
    }
  }, {
    key: "resetSegmentLoops",
    value: function resetSegmentLoops() {
      this.loopsManager.resetAll();
    }
  }, {
    key: "resetSegmentTitle",
    value: function resetSegmentTitle() {
      this.pushSegmentTitle("&nbsp;");
    }
  }, {
    key: "resetSelectedSegment",
    value: function resetSelectedSegment() {
      $('.sidebar-list-item.segment.active').toggleClass('active', false);
    }
  }, {
    key: "resetPackageOverview",
    value: function resetPackageOverview() {
      $('#packageOverviewWrapper').toggle(false);
      $('#packageOverviewWrapper').appendTo('body');
    }
  }, {
    key: "bailOut",
    value: function bailOut() {
    ...
    /*******************************************/
    value: function openPackage(strPackageID, bUpdateURL) {
      this.resetEverything();
    ...
    key: "openPackageWithSegment",
    value: function openPackageWithSegment(strPackageID, strSegmentID, bUpdateURL) {
      this.resetEverything();
      this.b_UpdateURL = bUpdateURL;
      this.beginFetchPackageData(strPackageID);
    ...
    key: "openSegmentWithinCurrentPackage",
    value: function openSegmentWithinCurrentPackage(strSegmentID, bUpdateURL) {
    ...
    key: "openExternalYouTubeVideo",
    value: function openExternalYouTubeVideo(strYTCode, bUpdateURL) {
      this.resetEverything();
      this.b_UpdateURL = bUpdateURL;
    ...
    key: "openExternalFBVideo",
    value: function openExternalFBVideo(strFBUserID, strFBVideoID, bUpdateURL) {
    ...
    key: "openExternalInstagramVideo",
    value: function openExternalInstagramVideo(strInstagramID, bUpdateURL) {
      //console.log("Opening FB Video for User/ID: " + strFBUserID + "," + strFBVideoID);
      this.resetEverything();
      this.b_UpdateURL = bUpdateURL;
    ...
    key: "openUnknownPackageType",
    value: function openUnknownPackageType(packageOptions, bUpdateURL) {
    ...
    key: "openUnknownPackageFromSegments",
    value: function openUnknownPackageFromSegments(strSegment1, strSegment2, strSegment3, bUpdateURL) {
      if (strSegment1 === "") {
    ...
    key: "beginFetchPackageData",

    /*****************************************
     *************   Begin Loading Functions  ************
     *****************************************/
    value: function beginFetchPackageData(strPackageID) {
    ...
    key: "beginFetchSegmentData",
    value: function beginFetchSegmentData(strSegmentID) {
      ...
      $.get(gc_BranchPath + '/--ajax-get-segment-info/' + strSegmentID, function (data) {
        ...
        var tempData = jQuery.parseJSON(data); //console.log(tempData);
    ...
    key: "beginFetchYouTubeData",
    value: function beginFetchYouTubeData(strYTCode) {
    ...
    key: "beginFetchFacebookData",
    value: function beginFetchFacebookData(strFBUser, strFBCode) {
      //segment info must be reset prior to calling this function.
      this.showMediaLoading();
    ...
    key: "beginFetchInstagramData",
    value: function beginFetchInstagramData(strInstgramID) {
      //segment info must be reset prior to calling this function.
      this.showMediaLoading();
    ...
    key: "waitForPackageData",

    /*****************************************
     *************   WAITING FUNCTIONS  ************
     *****************************************/
    value: function waitForPackageData() {
    ...
    key: "waitForSegmentData",
    value: function waitForSegmentData() {
    ...
    key: "waitForPackageAndSegmentData",
    value: function waitForPackageAndSegmentData() {
    ...
    key: "waitForYouTubeData",
    value: function waitForYouTubeData() {
      if (this.bSegmentDataLoadingFinished) {
    ...
    key: "waitForFacebookData",
    value: function waitForFacebookData() {
      if (this.bSegmentDataLoadingFinished) {
    ...
    key: "waitForInstagramData",
    value: function waitForInstagramData() {
      if (this.bSegmentDataLoadingFinished) {
    ...
    /*****************************************/
    value: function processOnlyNewPackageDat() {
      ...
      this.pushInfoPaneData(); //this function is called after package data has been loaded
    ...
    key: "processOnlyNewSegmentData",
    value: function processOnlyNewSegmentData() {
    ...
    key: "processBothNewPackageAndSegmentData",
    value: function processBothNewPackageAndSegmentData() {
      ...
      this.processOnlyNewSegmentMedia(); //Update interface elements related to Package.

      this.pushPackageSectionList();
      this.pushPackageTitle();
      this.pushInfoPaneData(); //Deal with comments.

      this.commentsManager.setNewPackageID(this.thePackage.getEntryID());
      this.commentsManager.setNewSegmentID(this.theSegment.getEntryID());
      this.commentsManager.reloadComments(); //this function is called after package data has been loaded

      this.favoritesManager.setNewPackageID(this.thePackage.getEntryID());
      this.favoritesManager.reloadFavorites(); //Now open the Sidebar

      this.openSectionsSidebar();
      this.openFirstSection(); //Now do the segment stuff that doesn't overlap with package stuff.
    ...
    key: "processNewYouTubeData",
    value: function processNewYouTubeData() {
    ...
    key: "processNewFacebookData",
    value: function processNewFacebookData() {
      //console.log("Processing new Facebook Data");
      this.processOnlyNewSegmentData();
      this.enableSidebarTabs();
    }
  }, {
    key: "processNewInstagramData",
    value: function processNewInstagramData() {
      //console.log("Processing new Facebook Data");
      this.processOnlyNewSegmentData();
      this.enableSidebarTabs();
    }
  }, {
    key: "processOnlyNewSegmentMedia",
    value: function processOnlyNewSegmentMedia() {
      this.resetPackageOverview();
      var mediaType = this.theSegment.getPrimaryMediaType(); //console.log("Processing new Segment Media:" + mediaType);
    ...
    key: "extractSegmentLoops",
    value: function extractSegmentLoops() {
    ...
    /*****************************
     */
    value: function pushHomeButtonState() {
    ...
    key: "pushPackageSectionList",
    value: function pushPackageSectionList() {
      ...
      for (var i = 0; i < sections.length; i++) {
        ...
        for (var j = 0; j < sections[i].segments.length; j++) {
    ...
    key: "pushPackageTitle",
    value: function pushPackageTitle(strTitleOverride) {
    ...
    key: "pushPackageOverviewData",
    value: function pushPackageOverviewData() {
    ...
    key: "pushSegmentTitle",
    value: function pushSegmentTitle(strTitle) {
    ...
    key: "pushInfoPaneData",
    value: function pushInfoPaneData() {
      $("#proPlayerWrapper").toggleClass("has-info", true);
    ...
    key: "pushSelectedSegmentState",
    value: function pushSelectedSegmentState(nForceSegment) {
    ...
    key: "pushSegmentDownloadsMenu",
    value: function pushSegmentDownloadsMenu() {
    ...
    key: "pushFullscreenButtonState",
    value: function pushFullscreenButtonState() {
    ...
    key: "pushSegmentChapters",
    value: function pushSegmentChapters() {
      if (!this.theSegment.isLoaded()) {
        $('#chapterListEmpty').text("No segment loaded.");
        $('#chapterListEmpty').toggle(true);
    ...
    key: "mediaLoadFacebook",
    value: function mediaLoadFacebook(strFacebookUser, strFacebookCode) {
    ...
    key: "mediaLoadInstagram",
    value: function mediaLoadInstagram(strInstagramID) {
      //console.log("About to load FB video for user/id: " + strFacebookUser + "," + strFacebookCode);
      this.showMediaLoading();
    ...
    key: "triggerSaveUserData",
    value: function triggerSaveUserData() {
    ...
    /**********************************/
    value: function chapterSelected(sender, nChapterIndex) {
    ...
    key: "engineLoopHasChanged",
    value: function engineLoopHasChanged() {
      this.loopsManager.pushUserLoopInterfaceState();
    }
  }, {
    key: "toolsShowBrowser",

    /*****************************************
     *************	Tool Window Functions ************
     *****************************************/
    value: function toolsShowBrowser() {
    ...
    key: "toolsShowSpiderTool",
    value: function toolsShowSpiderTool() {
      this.closeInfoPane();
    ...
    key: "toolsShowFretboardTool",
    value: function toolsShowFretboardTool() {
      this.closeInfoPane();
    ...
    key: "toolsCloseToolWindow",
    value: function toolsCloseToolWindow() {
    ...
    /**********************************/
    value: function getSegmentClass(theSegment) {
    ...
    key: "toggleSidebarButtonCallback",
    value: function toggleSidebarButtonCallback() {
      if ($('#proPlayerWrapper').hasClass('sidebar-closed')) {
    ...
    key: "enableSidebarTabs",
    value: function enableSidebarTabs() {
    ...
    value: function toggleKeyboardShortcuts() {
      $("#keyboardShortcuts").toggle();
      $("#keyboardShortcutsButton").toggleClass('active');
    }
  }, {
    key: "openFirstSection",
    value: function openFirstSection() {
    ...
    key: "openSectionsSidebar",
    value: function openSectionsSidebar() {
      this.openSidebar();
      $('#sidebarPanelTabs').foundation('selectTab', 'segmentsPanel');
    }
  }, {
    key: "openChaptersSidebar",
    value: function openChaptersSidebar() {
      this.openSidebar();
      $('#sidebarPanelTabs').foundation('selectTab', 'chaptersPanel');
    }
  }, {
    key: "openLoopsSidebar",
    value: function openLoopsSidebar() {
      this.openSidebar();
      $('#sidebarPanelTabs').foundation('selectTab', 'loopsPanel');
    }
  }, {
    key: "showLoopsSidebarList",
    value: function showLoopsSidebarList(nListIndex) {
      this.openLoopsSidebar();
      var listTab = $('#loopListsTabsContent').children('.tabs-panel')[nListIndex];
      var tabID = $(listTab).attr('id');
      $('#loopsPanelTabs').foundation('selectTab', tabID);
    }
  }, {
    key: "openFavoritesSidebar",
    value: function openFavoritesSidebar() {
      this.openSidebar();
      $('#sidebarPanelTabs').foundation('selectTab', 'favoritesPanel');
    }
  }, {
    key: "openCommentsSidebar",
    value: function openCommentsSidebar() {
      this.openSidebar();
      $('#sidebarPanelTabs').foundation('selectTab', 'commentsPanel');
    }
  }, {
    key: "mobileSidebarCheck",
    value: function mobileSidebarCheck() {
    ...
    value: function updateURL() {
      ...
      var bPushNewState = true; //First, check if we're pushing the same state that we already have loaded.
    ...
    key: "isWindows10",
    value: function isWindows10() {
      strUserAgent = window.navigator.userAgent;
      return strUserAgent.search('Windows NT 10') > -1;
    }
  }, {
    key: "getChannelTypeString",
    value: function getChannelTypeString(strChannelShortName) {
      var strType = 'Item';
    ...
    key: "spinner",
    value: function spinner(elementID) {
    ...
    key: "closeBrowserRequested",
    value: function closeBrowserRequested() {
      this.toolsCloseToolWindow();
      this.favoritesManager.fullRefresh();
    }
  }, {
    key: "updateLocalHistory",
    value: function updateLocalHistory() {
    ...
    key: "closeInfoPane",
    value: function closeInfoPane() {
      $('#infoPane').toggle(false);
    }
  }, {
    key: "showMediaLoading",
    value: function showMediaLoading() {
      this.resetPackageOverview();
      $('#mediaWrapper').html(this.spinnerDiv);
    }
  }, {
    key: "triggerNextLoop",
    value: function triggerNextLoop() {
      var listIndex = this.loopsManager.activateNextLoop();
    ...
    key: "triggerPreviousLoop",
    value: function triggerPreviousLoop() {
      var listIndex = this.loopsManager.activatePreviousLoop();
    ...
    key: "reattachKeyboardEvents",
    value: function reattachKeyboardEvents() {
    ...
    key: "convertOldCookies",
    value: function convertOldCookies() {
      //Resolution
    ...
    key: "showPlayerError",
    value: function showPlayerError() {//console.log("Player Error");
    }
  }, {
    key: "loadSaveYouTubeInterface",

    /*****************************************
     *************   External Video Code  ************
     *****************************************/
    value: function loadSaveYouTubeInterface() {
    ...
    key: "submitSaveYouTubeForm",
    value: function submitSaveYouTubeForm() {
      var theName = $("form#saveYouTubeSegmentForm input[name=title]").val();
      var theDisplayName = $("form#saveYouTubeSegmentForm input[name=cf_media_display_name]").val();
      var theYTCode = $("form#saveYouTubeSegmentForm input[name=cf_media_yt_code]").val();
    ...
    key: "reloadYouTube",
    value: function reloadYouTube() {
      this.openExternalYouTubeVideo(this.theSegment.getYouTubeCode(), false);
    }
  }, {
    key: "showYouTubeLinkPrompt",
    value: function showYouTubeLinkPrompt() {
    ...
    key: "showFacebookLinkPrompt",
    value: function showFacebookLinkPrompt() {
    ...
    key: "showInstagramLinkPrompt",
    value: function showInstagramLinkPrompt() {
    ...
    key: "testFetchYouTubeData",
    value: function testFetchYouTubeData(strYTCode) {
      $.get(gc_BranchPath + '/--ajax-get-yt-info/' + strYTCode, function (data) {
        var theData = jQuery.parseJSON(data); //console.log(theData);
      });
    }
  }, {
    key: "startSidebarToggleHover",
    value: function startSidebarToggleHover() {
    ...
    key: "cancelSidebarToggleHover",
    value: function cancelSidebarToggleHover() {
      clearTimeout(this.n_SidebarToggleTimerID);
      n_SidebarToggleTimerID = -1;
    }
  }, {
    key: "enginePlaybackToggled",
    value: function enginePlaybackToggled(bIsPlaying) {
...
},{"mobile-detect":"node_modules/mobile-detect/mobile-detect.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","--js-ProPlayer.js"], null)
//# sourceMappingURL=/--js-ProPlayer.31b654ee.js.map