...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"--js-ProPlayerUserDataManager.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }

function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

var ProPlayerUserDataManager = function ProPlayerUserDataManager() {
  _classCallCheck(this, ProPlayerUserDataManager);
  ...
  this.processImportedSegmentLoops = function (arrImportedLoops) {
    if (this.validateJSON(arrImportedLoops)) {
      var theImportedLoopData = JSON.parse(arrImportedLoops);
      thePlayer.loopsManager.createNewCollection("communityLoopList", "community", false);

      for (var i = 0; i < theImportedLoopData.memberLoopCollections.length; i++) {
        var theMemberLoops = theImportedLoopData.memberLoopCollections[i];
  ...
  this.updateUserDataForm = function () {
    var userLoopsArray = thePlayer.loopsManager.getUserLoopsArray();
...
},{}]},{},["node_modules/parcel/src/builtins/hmr-runtime.js","--js-ProPlayerUserDataManager.js"], null)
//# sourceMappingURL=/--js-ProPlayerUserDataManager.31c354f8.js.map