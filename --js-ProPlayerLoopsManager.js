function ProPlayerLoopsManager()
{
	...
	this.hasLists = function(){ return this.a_Collections.length > 0; }
	...
	this.getLastActiveListID = function(){ return this.n_LastActiveCollectionID; }
...
function ProPlayerLoopsCollection( nCollectionID, strListWrapperID, strCollectionRole, bEditable )
{
	...
	this.getListCount = function(){ return this.a_Lists.length; }
	this.getID = function(){ return this.n_CollectionID; }
	this.getRole = function(){ return this.str_Role; }
	this.getEditable = function(){ return this.b_Editable;}
	this.isDirty = function(){ return this.b_IsDirty;}
	this.setDirty = function(bDirty){ this.b_IsDirty = bDirty; }
	this.clearLoopsUIList = function(){ $(this.str_UIWrapperID).empty(); }
...
function ProPlayerLoopsList( nCollectionID, nListID, strListTitle )
{
	...
	this.getCollectionID = function(){ return this.n_CollectionID }
	this.getListID = function(){ return this.n_ListID }
	this.getListTitle = function(){ return this.str_ListTitle;}
	this.setLoopsList = function( a_newLoopsList ){ this.a_Loops = a_newLoopsList; }
	this.getLoopAt = function( nIndex ){ return this.a_Loops[nIndex]; }
	this.getLoopStart = function( nIndex ){ return this.getLoopAt(nIndex).getLoopStart(); }
	this.getLoopEnd = function( nIndex ){ return this.getLoopAt(nIndex).getLoopEnd(); }
	this.getListLoopCount = function(){ return this.a_Loops.length; }
	this.reset = function()
	{
	...
	this.findMatchingLoop = function( loopToMatch )
	{
		...
		for(let i = 0; i < this.a_Loops.length; i++ )
		{
			...
			if( Math.abs(loopToMatch.getLoopStart() - myLoop.getLoopStart()) < .1 &&
				Math.abs( loopToMatch.getLoopEnd() - myLoop.getLoopEnd()) < .1)
			{
				bMatchFound = true;
			}
		}
...
function InstantLoop( strName, fStartTime, fStopTime )
{
	...
	//Setters
	this.setLoopStart = function( fStartTime ){ this.f_StartTime = parseFloat(fStartTime); }
	this.setLoopEnd = function( fEndTime ){ this.f_EndTime = parseFloat(fStopTime); }
	this.setStackable = function( bStackable ){ this.b_Stackable = bStackable; }
	this.setChecked = function( bChecked ){ this.b_Checked = bChecked; }
	this.setName = function( strName ){ this.str_Name = strName; }
	
	//Getters
	this.getLoopStart = function(){ return this.f_StartTime; }
	this.getLoopEnd = function(){ return this.f_EndTime; }
	this.getStackable = function(){ return this.b_Stackable; }
	this.getChecked = function(){ return this.b_Checked; }
	...
	{
		if( this.f_EndTime < (this.f_StartTime + .1))
		{
			return false;
		}
		return true;
