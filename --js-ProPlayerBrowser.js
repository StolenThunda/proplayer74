...
*****************************************/ 
	...
	this.toggleSearchFilter = function(strFilterID, strSectionID)
	{
		...
		if(bWasChecked == undefined){ bWasChecked = false; }
	...
	this.processDependents = function( strMasterSectionID )
	{
		...
		*/
		...
		{	
			...
			if( theTagKeys == "" ){ theTagKeys = "-1"}
			if( theCategoryKeys == ""){theCategoryKeys = "-1"}
...
function BrowserFilterSection()
{
	...
	this.setSectionID = function( strID ){ this.str_SectionID = strID;}
	this.setSectionDOMID = function( strID ){ this.sectionDOMID = strID;}
	this.setSectionType = function( strType ){ this.str_SectionType = strType;}
	this.setChannelID = function( strID ){ this.str_ChannelID = strID;}
	this.setGroupID = function( strID ){ this.str_GroupID = strID;}

	this.getSectionID = function(){ return this.str_SectionID}
	this.getSectionDOMID = function(){ return this.sectionDOMID}
	this.getSectionType = function(){ return this.str_SectionType}
	this.getChannelID = function(){ return this.str_ChannelID}
	this.getGroupID = function(){ return this.str_GroupID}

	
	this.setParentIDs = function( aParentIDs ){ this.a_ParentIDs = aParentIDs; }
	this.getParentIDs = function(){ return this.a_ParentIDs; }
	
	this.getChildren = function(){ return this.a_Children; }
	this.addChild = function( objChild )
	{
		this.a_Children.push(objChild);
	}
	
	this.getParents = function(){ return this.a_Parents;}
